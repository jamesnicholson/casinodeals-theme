					...
					<div class="space-header-logo-ins relative">
						<?php
							...
							if ( has_custom_logo() ) {
								...
								echo '<a href="'. esc_url( home_url( '/' ) ) .'" title="'. esc_attr( get_bloginfo( 'name' ) ) .'" class="text-logo">Casino<i class="fas fa-crown"></i><span class="logo-bolder">Deals</span></a><span>'. esc_html( get_bloginfo( 'description' ) ) .'</span>';
							}
						?>
					</div>
				</div>
