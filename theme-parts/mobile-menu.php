		...
		<div class="space-mobile-menu-block-ins relative">
			<div class="space-mobile-menu-header relative text-center">
				<?php
					...
					if ( has_custom_logo() ) {
						...
						echo '<a href="'. esc_url( home_url( '/' ) ) .'" title="'. esc_attr( get_bloginfo( 'name' ) ) .'" class="text-logo">Casino<i class="fas fa-crown"></i><span class="logo-bolder">Deals</span></a><span class="logo-mobile-description">'. esc_html( get_bloginfo( 'description' ) ) .'</span>';
					}
				?>		
			</div>
			...
			<div class="space-mobile-menu-copy relative text-center">
				<?php if(get_theme_mod('footer_copyright') == '') { ?>
					<?php esc_html_e( '&copy; Copyright', 'mercury' ); ?> <?php echo esc_html( date( 'Y' ) ) ?> <?php echo esc_html( get_bloginfo( 'name' ) ) ?>
				<?php } else { ?>
					<?php 
						$allowed_html = array(
							'a' => array(
