		...
		<div class="space-page-section box-100 relative">
			<div class="space-page-section-ins space-page-wrapper relative">
				<div class="space-content-section box-75 left relative">
						...
						<div class="space-aces-single-bonus-info box-100 relative"<?php $src = wp_get_attachment_image_src(get_post_thumbnail_id(), 'mercury-900-675'); if ($src) { ?> style="background-image: url(<?php echo esc_url($src[0]); ?>);"<?php } ?>>
							...
							<div class="space-aces-single-bonus-info-ins relative">
								<div class="space-aces-single-bonus-info-ins-wrap relative">
									...
									<?php } ?>
									<div class="space-aces-single-bonus-info-button box-100">
											<div class="space-aces-single-bonus-info-button-ins text-center">
									...
									<div class="space-aces-single-bonus-info-code-button box-100 "<?php if (! $bonus_short_desc) { ?> style="padding-top: 85px;"<?php } ?>>

										<?php if ($bonus_code) { 
											$review_link = get_field( 'review_link', $post->ID );
											?>

										<div class="space-aces-single-bonus-info-code relative">
											<a  href="<?php echo $review_link; ?>" class="space-aces-single-bonus-info-code-ins relative">
												<fieldset class="space-aces-single-bonus-info-code-value relative">
													<legend><?php esc_html_e( 'Read our', 'mercury' ); ?></legend>
													<span>
					...
					<?php $bonus_perks = get_field( 'bonus_perks', $post->ID ); 
						if($bonus_perks){
							?>
							<div class="bonus space-pros-cons box-100 relative">
